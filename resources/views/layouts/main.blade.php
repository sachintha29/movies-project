        ...
        <nav class="border-b border-gray-800">
           <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="#" class="hover:text-white-300">Movies</a>
                </li>
           ...
           <div class="flex flex-col md:flex-row items-center">
                <div class="relative">
                  ...
                  <div class="absolute top-0">
                    <svg  class="fill-current text-gray-500 w-5 mt-1 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path d="M21 3a17 17 0 1010 31l13 13 3-3-13-13c2-3 4-7 4-11 0-9-8-17-17-17zm0 2a15 15 0 110 30 15 15 0 010-30z"/></svg> </div>
                </div>
